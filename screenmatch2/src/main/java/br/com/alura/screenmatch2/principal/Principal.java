...
import br.com.alura.screenmatch2.models.DadosEpisiodio;
...
public class Principal {
    ...
    public void exibeMenu() {
        System.out.println("Digite o nome da série para buscá-la");
        ...
        List<DadosEpisiodio> dadosEpisiodios = temporadas.stream()
                .flatMap(t -> t.episodios().stream())
                .collect(Collectors.toList());

/*        System.out.println("\nTop 10 episódios");
        dadosEpisiodios.stream()
                .filter(e -> !e.avaliacao().equalsIgnoreCase("N/A"))
                .peek(e -> System.out.println("Primeiro filtro(N/A) " + e))
                .sorted(Comparator.comparing(DadosEpisiodio::avaliacao).reversed())
